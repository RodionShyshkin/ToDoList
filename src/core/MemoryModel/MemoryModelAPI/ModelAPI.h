...
class ModelAPI : public ModelAPIInterface {
 ...
 public:
  ...
  OperationResult<SerializationError>             saveToDisk(const std::string& path) override;
  OperationResult<SerializationError>             loadFromDisk(const std::string& path) override;
